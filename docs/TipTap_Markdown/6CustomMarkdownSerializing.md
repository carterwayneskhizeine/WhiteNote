...
## [](#understanding-render-handlers)Understanding Render Handlers
...
### [](#helpersrenderchildrennodes-separator)`helpers.renderChildren(nodes, separator)`
...
### [](#helpersindentcontent)`helpers.indent(content)`
...
### [](#helperswrapinblockprefix-content)`helpers.wrapInBlock(prefix, content)`
...
## [](#serializing-marks)Serializing Marks
...
### [](#marks-with-attributes)Marks with Attributes
...
## [](#rendering-with-indentation)Rendering with Indentation
...
### [](#custom-indentation-logic)Custom Indentation Logic
...
## [](#debug-serialization)Debug Serialization
...
### [](#debug-serialization-in-isolation)Debug Serialization in Isolation
...
### [](#custom-heading-renderer)Custom Heading Renderer
...
### [](#youtube-embed-renderer)YouTube Embed Renderer
...
### [](#rendering-list-items-with-indentation)Rendering list items with indentation

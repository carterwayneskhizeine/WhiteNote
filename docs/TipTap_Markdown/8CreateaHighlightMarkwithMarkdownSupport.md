...
## [](#step-1-create-the-basic-highlight-mark)Step 1: Create the basic `highlight` Mark
...
## [](#step-2-add-a-custom-markdown-tokenizer)Step 2: Add a custom Markdown tokenizer
...
## [](#step-3-add-the-parser)Step 3: Add the parser
...
## [](#step-4-add-the-renderer)Step 4: Add the renderer

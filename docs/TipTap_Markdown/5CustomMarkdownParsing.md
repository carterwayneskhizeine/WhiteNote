...
## [](#creating-and-understanding-a-parse-handler)Creating and understanding a parse handler
...
## [](#parse-helper-functions)Parse Helper Functions
...
### [](#parse-inline-level-child-token-with-helpersparseinlinetokens)Parse inline-level child token with `helpers.parseInline(tokens)`
...
### [](#parse-block-level-child-token-with-helpersparsechildrentokens)Parse block-level child token with `helpers.parseChildren(tokens)`
...
### [](#parsing-marks-with-helpersparseinline-and-helpersapplymark)Parsing Marks with `helpers.parseInline()` and `helpers.applyMark()`
...
## [](#html-parsing-in-markdown)HTML Parsing in Markdown
...
## [](#defining-the-markdown-token-name)Defining the Markdown token name
...
### [](#parse-tokens-in-isolation)Parse tokens in isolation
...
### [](#custom-heading-parser)Custom Heading Parser
...
### [](#custom-youtube-embed-parser)Custom YouTube Embed Parser

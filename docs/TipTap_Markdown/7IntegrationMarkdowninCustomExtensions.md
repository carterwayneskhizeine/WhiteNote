...
## [](#basic-extension-integration)Basic Extension Integration
...
## [](#the-markdown-configuration-explained)The Markdown Configuration Explained
...
### [](#using-markdowntokenname)Using `markdownTokenName`
...
### [](#unit-test-parse-handler)Unit Test Parse Handler
...
### [](#unit-test-render-handler)Unit Test Render Handler
...
### [](#handle-optional-token-properties)Handle Optional Token Properties

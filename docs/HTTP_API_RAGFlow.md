...
OpenAI-Compatible API[](#openai-compatible-api "Direct link to OpenAI-Compatible API")
--------------------------------------------------------------------------------------
...
### Create agent completion[](#create-agent-completion "Direct link to Create agent completion")
...
##### A basic request example[](#a-basic-request-example "Direct link to A basic request example")
...
##### A request example specifying ingestion pipeline[](#a-request-example-specifying-ingestion-pipeline "Direct link to A request example specifying ingestion pipeline")

WARNING

You must _not_ include `"chunk_method"` or `"parser_config"` when specifying an ingestion pipeline.
...
##### Request parameters[](#request-parameters-2 "Direct link to Request parameters")
...
You can choose either of the following ingestion options when creating a dataset, but _not_ both:
...
### Delete datasets[](#delete-datasets "Direct link to Delete datasets")
...
##### Request example[](#request-example-2 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-3 "Direct link to Request parameters")
...
##### Request example[](#request-example-3 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-4 "Direct link to Request parameters")
...
##### Request example[](#request-example-4 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-5 "Direct link to Request parameters")
...
### Get knowledge graph[](#get-knowledge-graph "Direct link to Get knowledge graph")
...
##### Request example[](#request-example-5 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-6 "Direct link to Request parameters")
...
### Delete knowledge graph[](#delete-knowledge-graph "Direct link to Delete knowledge graph")
...
##### Request example[](#request-example-6 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-7 "Direct link to Request parameters")
...
### Construct knowledge graph[](#construct-knowledge-graph "Direct link to Construct knowledge graph")
...
##### Request example[](#request-example-7 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-8 "Direct link to Request parameters")
...
### Get knowledge graph construction status[](#get-knowledge-graph-construction-status "Direct link to Get knowledge graph construction status")
...
##### Request example[](#request-example-8 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-9 "Direct link to Request parameters")
...
### Construct RAPTOR[](#construct-raptor "Direct link to Construct RAPTOR")
...
##### Request example[](#request-example-9 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-10 "Direct link to Request parameters")
...
### Get RAPTOR construction status[](#get-raptor-construction-status "Direct link to Get RAPTOR construction status")
...
##### Request example[](#request-example-10 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-11 "Direct link to Request parameters")
...
FILE MANAGEMENT WITHIN DATASET[](#file-management-within-dataset "Direct link to FILE MANAGEMENT WITHIN DATASET")
-----------------------------------------------------------------------------------------------------------------

* * *

### Upload documents[](#upload-documents "Direct link to Upload documents")
...
##### Request example[](#request-example-11 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-12 "Direct link to Request parameters")
...
##### Request example[](#request-example-12 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-13 "Direct link to Request parameters")
...
##### Request example[](#request-example-13 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-14 "Direct link to Request parameters")
...
##### Request parameters[](#request-parameters-15 "Direct link to Request parameters")
...
##### Request example[](#request-example-14 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-16 "Direct link to Request parameters")
...
### Parse documents[](#parse-documents "Direct link to Parse documents")
...
##### Request example[](#request-example-15 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-17 "Direct link to Request parameters")
...
### Stop parsing documents[](#stop-parsing-documents "Direct link to Stop parsing documents")
...
##### Request example[](#request-example-16 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-18 "Direct link to Request parameters")
...
CHUNK MANAGEMENT WITHIN DATASET[](#chunk-management-within-dataset "Direct link to CHUNK MANAGEMENT WITHIN DATASET")
--------------------------------------------------------------------------------------------------------------------

* * *

### Add chunk[](#add-chunk "Direct link to Add chunk")
...
##### Request example[](#request-example-17 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-19 "Direct link to Request parameters")
...
### List chunks[](#list-chunks "Direct link to List chunks")
...
##### Request example[](#request-example-18 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-20 "Direct link to Request parameters")
...
### Delete chunks[](#delete-chunks "Direct link to Delete chunks")
...
##### Request example[](#request-example-19 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-21 "Direct link to Request parameters")
...
### Update chunk[](#update-chunk "Direct link to Update chunk")
...
##### Request example[](#request-example-20 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-22 "Direct link to Request parameters")
...
### Retrieve a metadata summary from a dataset[](#retrieve-a-metadata-summary-from-a-dataset "Direct link to Retrieve a metadata summary from a dataset")
...
### Update or delete metadata[](#update-or-delete-metadata "Direct link to Update or delete metadata")
...
#### Request parameters[](#request-parameters-23 "Direct link to Request parameters")
...
##### Request example[](#request-example-21 "Direct link to Request example")
...
### Retrieve chunks[](#retrieve-chunks "Direct link to Retrieve chunks")
...
##### Request example[](#request-example-22 "Direct link to Request example")
...
*   `"metadata_condition"`: (_Body parameter_), `object`  
    ...
    *   `"conditions"`: (_Body parameter_), `array`  
        ...
        *   `"name"`: `string` - The metadata field name to filter by, e.g., `"author"`, `"company"`, `"url"`. Ensure this parameter before use. See [Set metadata](https://ragflow.io/docs/set_metadata) for details.
...
CHAT ASSISTANT MANAGEMENT[](#chat-assistant-management "Direct link to CHAT ASSISTANT MANAGEMENT")
--------------------------------------------------------------------------------------------------

* * *

### Create chat assistant[](#create-chat-assistant "Direct link to Create chat assistant")
...
##### Request example[](#request-example-23 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-24 "Direct link to Request parameters")
...
*   `"llm"`: (_Body parameter_), `object`  
    ...
    *   `"model_name"`, `string`  
    ...
    `model_type` is an _internal_ parameter, serving solely as a temporary workaround for the current model-configuration design limitations.
...
### Update chat assistant[](#update-chat-assistant "Direct link to Update chat assistant")
...
##### Request example[](#request-example-24 "Direct link to Request example")
...
### Delete chat assistants[](#delete-chat-assistants "Direct link to Delete chat assistants")
...
##### Request example[](#request-example-25 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-25 "Direct link to Request parameters")
...
### List chat assistants[](#list-chat-assistants "Direct link to List chat assistants")
...
##### Request example[](#request-example-26 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-26 "Direct link to Request parameters")
...
### Create session with chat assistant[](#create-session-with-chat-assistant "Direct link to Create session with chat assistant")
...
##### Request example[](#request-example-27 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-27 "Direct link to Request parameters")
...
### Update chat assistant's session[](#update-chat-assistants-session "Direct link to Update chat assistant's session")
...
##### Request example[](#request-example-28 "Direct link to Request example")
...
### List chat assistant's sessions[](#list-chat-assistants-sessions "Direct link to List chat assistant's sessions")
...
##### Request example[](#request-example-29 "Direct link to Request example")
...
##### Request Parameters[](#request-parameters-28 "Direct link to Request Parameters")
...
### Delete chat assistant's sessions[](#delete-chat-assistants-sessions "Direct link to Delete chat assistant's sessions")
...
##### Request example[](#request-example-30 "Direct link to Request example")
...
##### Request Parameters[](#request-parameters-29 "Direct link to Request Parameters")
...
### Converse with chat assistant[](#converse-with-chat-assistant "Direct link to Converse with chat assistant")
...
##### Request example[](#request-example-31 "Direct link to Request example")
...
##### Request Parameters[](#request-parameters-30 "Direct link to Request Parameters")
...
### Create session with agent[](#create-session-with-agent "Direct link to Create session with agent")
...
##### Request example[](#request-example-32 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-31 "Direct link to Request parameters")
...
### Converse with agent[](#converse-with-agent "Direct link to Converse with agent")
...
#### Streaming events to handle[](#streaming-events-to-handle "Direct link to Streaming events to handle")
...
You can include custom parameters in the request body, but first ensure they are defined in the [Begin](https://ragflow.io/docs/begin_component) component.

##### Request example[](#request-example-33 "Direct link to Request example")
...
##### Request Parameters[](#request-parameters-32 "Direct link to Request Parameters")
...
For now, this method does _not_ support a file type input/variable. As a workaround, use the following to upload a file to an agent:  
...
### List agent sessions[](#list-agent-sessions "Direct link to List agent sessions")
...
##### Request example[](#request-example-34 "Direct link to Request example")
...
##### Request Parameters[](#request-parameters-33 "Direct link to Request Parameters")
...
### Delete agent's sessions[](#delete-agents-sessions "Direct link to Delete agent's sessions")
...
##### Request example[](#request-example-35 "Direct link to Request example")
...
##### Request Parameters[](#request-parameters-34 "Direct link to Request Parameters")
...
### Generate related questions[](#generate-related-questions "Direct link to Generate related questions")
...
##### Request example[](#request-example-36 "Direct link to Request example")
...
##### Request Parameters[](#request-parameters-35 "Direct link to Request Parameters")
...
##### Request example[](#request-example-37 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-36 "Direct link to Request parameters")
...
##### Request example[](#request-example-38 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-37 "Direct link to Request parameters")
...
#### Request[](#request-42 "Direct link to Request")
...
##### Request example[](#request-example-39 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-38 "Direct link to Request parameters")
...
#### Response[](#response-42 "Direct link to Response")
...
### Delete agent[](#delete-agent "Direct link to Delete agent")

**DELETE** `/api/v1/agents/{agent_id}`

Delete an agent by id.

#### Request[](#request-43 "Direct link to Request")
...
##### Request example[](#request-example-40 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-39 "Direct link to Request parameters")

*   `agent_id`: (_Path parameter_), `string`  
    The id of the agent to be deleted.

#### Response[](#response-43 "Direct link to Response")
...
##### Request example[](#request-example-41 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-40 "Direct link to Request parameters")
...
#### Request[](#request-45 "Direct link to Request")
...
##### Request example[](#request-example-42 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-41 "Direct link to Request parameters")
...
#### Response[](#response-44 "Direct link to Response")
...
### Create file or folder[](#create-file-or-folder "Direct link to Create file or folder")

**POST** `/api/v1/file/create`

Creates a new file or folder in the system.

#### Request[](#request-46 "Direct link to Request")
...
##### Request example[](#request-example-43 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-42 "Direct link to Request parameters")
...
#### Response[](#response-45 "Direct link to Response")
...
#### Request[](#request-47 "Direct link to Request")
...
##### Request example[](#request-example-44 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-43 "Direct link to Request parameters")
...
#### Response[](#response-46 "Direct link to Response")
...
### Get root folder[](#get-root-folder "Direct link to Get root folder")

**GET** `/api/v1/file/root_folder`

Retrieves the user's root folder information.

#### Request[](#request-48 "Direct link to Request")
...
##### Request example[](#request-example-45 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-44 "Direct link to Request parameters")

No parameters required.

#### Response[](#response-47 "Direct link to Response")
...
##### Request example[](#request-example-46 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-45 "Direct link to Request parameters")

*   `file_id`: (_Filter parameter_), `string`, _Required_  
    The ID of the file whose immediate parent folder to retrieve.

#### Response[](#response-48 "Direct link to Response")
...
### Get all parent folders[](#get-all-parent-folders "Direct link to Get all parent folders")
...
#### Request[](#request-50 "Direct link to Request")
...
##### Request example[](#request-example-47 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-46 "Direct link to Request parameters")

*   `file_id`: (_Filter parameter_), `string`, _Required_  
    The ID of the file whose parent folders to retrieve.

#### Response[](#response-49 "Direct link to Response")
...
#### Request[](#request-51 "Direct link to Request")
...
##### Request example[](#request-example-48 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-47 "Direct link to Request parameters")

*   `"file_ids"`: (_Body parameter_), `list[string]`, _Required_  
    The IDs of the files or folders to delete.

#### Response[](#response-50 "Direct link to Response")
...
#### Request[](#request-52 "Direct link to Request")
...
##### Request example[](#request-example-49 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-48 "Direct link to Request parameters")
...
#### Response[](#response-51 "Direct link to Response")
...
#### Request[](#request-53 "Direct link to Request")
...
##### Request example[](#request-example-50 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-49 "Direct link to Request parameters")

*   `file_id`: (_Path parameter_), `string`, _Required_  
    The ID of the file to download.

#### Response[](#response-52 "Direct link to Response")
...
### Move files[](#move-files "Direct link to Move files")

**POST** `/api/v1/file/mv`

Moves one or multiple files or folders to a specified folder.

#### Request[](#request-54 "Direct link to Request")
...
##### Request example[](#request-example-51 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-50 "Direct link to Request parameters")
...
#### Response[](#response-53 "Direct link to Response")
...
### Convert files to documents and link them to datasets[](#convert-files-to-documents-and-link-them-to-datasets "Direct link to Convert files to documents and link them to datasets")

**POST** `/api/v1/file/convert`

Converts files to documents and links them to specified datasets.

#### Request[](#request-55 "Direct link to Request")
...
##### Request example[](#request-example-52 "Direct link to Request example")
...
##### Request parameters[](#request-parameters-51 "Direct link to Request parameters")
...
#### Response[](#response-54 "Direct link to Response")
